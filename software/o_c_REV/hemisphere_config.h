#define HEMISPHERE_AVAILABLE_APPLETS 25
#define HEMISPHERE_APPLETS { \
    ...
    DECLARE_APPLET(21, LowerRenz), \
    DECLARE_APPLET(19, GameOfLife), \
    DECLARE_APPLET(150, hMIDIIn), \
    DECLARE_APPLET(27, hMIDIOut), \
    DECLARE_APPLET(23, Scope), \
}
